...
shinyUI(fluidPage(
    ...
    titlePanel("Human CNS gene expression & RNA editing browser"),
            ...
            tabPanel('About',
                     br(),
                     h5('Welcome to the CNS browser. Created by Brendan Ansell, Bahlo Laboratory, Walter + Eliza Hall Institute. \n In this browser you can investigate gene expression levels in single neuronal nuclei assayed in the studies below, as well as RNA editing events in those nuclei.'),
                     br(),
                     h5("Please use the tabs to search for your gene or editing site of interest"),
                     br(),br(),
            ...
            tabPanel('RNA editing',
                     ...
                     #    sidebarPanel(
                      mainPanel(
                          fluidRow(
                            br()
                            ,h4("Welcome to the CNS browser for healthy brain single-neuron RNA editing. Here you can explore RNA editing sites quantified in transcriptomes from single neuronal nuclei published by", a('Lake et al, Science 2016.', href='https://science.sciencemag.org/content/352/6293/1586')) 
                            ...
                            ,br()
                            ,textInput('ed_siteID', 'RNA editing site ID (chr_position):', value = '4_21541850')
